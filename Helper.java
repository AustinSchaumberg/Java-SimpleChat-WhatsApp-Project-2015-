...
public class Helper
{
    ...
    {
        //TODO
    	// creates an iterator that combs through the local contact list
    	// compares it to the string, and if the string matches the current user
    	// then returns the matching user.
    	Iterator<User> userIterator = users.iterator();
    	while(userIterator.hasNext())
    	{
    		User findUser = userIterator.next();
    		if(userIterator.equals(nickname))
    		{
    			return findUser;
    		}
    	}
    ...
    {
        //TODO
    	Iterator<BroadcastList> bcastIterator = lists.iterator();
    	while(bcastIterator.hasNext())
    	{
    		BroadcastList findBcast = bcastIterator.next();
    		if(bcastIterator.equals(nickname))
    		{
    			return findBcast;
    		}
    	}
    ...
    {
        //TODO
    	// creates an iterator that combs through the global contact list
    	// compares it to the string, and if the string matches the current user
    	// then returns true.
    	Iterator<User> userIterator = 
    			Config.getInstance().getAllUsers().iterator();
    	while(userIterator.hasNext())
    	{
    		User findUser = userIterator.next();
    		if(userIterator.equals(nickname))
